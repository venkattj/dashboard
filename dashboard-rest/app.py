...
from routes import variable_chits, chits, fixed_deposits, savings, home_loans, db_routes, ui_routes, investments , earnings,spendings  # Import the new investments blueprint
